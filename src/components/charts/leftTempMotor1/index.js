...
const LeftTempMotor1 = ({ data, range }) => {
    ...
    datasets: [
      {
        label: "km/h",
        data: data.map(
          (item) => item["mean_HPI_FL_phase_curr_motor_temp:HPI_temp_motor1"]
        ),
  ...
  return (
    <div className="section">
      <h2 className="black heading2center">Front Left Motor 1 Temp</h2>
      <div className="chart">
