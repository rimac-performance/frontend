...
const RightTempMotor2 = ({ data, range }) => {
    ...
    datasets: [
      {
        label: "km/h",
        data: data.map(
          (item) => item["mean_HPI_FR_phase_curr_motor_temp:HPI_temp_motor2"]
        ),
  ...
  return (
    <div className="section">
      <h2 className="black heading2center">Front Right Motor 2 Temp </h2>
      <div className="chart">
...
export default RightTempMotor2;
